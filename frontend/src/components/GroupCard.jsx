...
const GroupCard = ({key,setgroupData,groupData,allgroupsdata,setSelectedGroup, selectedGroup}) => {
  ...
  return (
    ...
    <Card  border="success" className='mx-4 my-4' style={{}} >
      <Card.Body>
        ...
        <Button variant="primary" onClick={handleOpenGroup} style={{"cursor":"pointer"}}> Open Group</Button>
        </div>
      </Card.Body>
    </Card>
